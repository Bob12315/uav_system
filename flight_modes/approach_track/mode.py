...
class ApproachTrackMode:
    ...
    def update(self, inputs: FlightModeInput) -> tuple[FlightCommand, FlightModeStatus]:
        ...
        return command, FlightModeStatus(
            mode_name=mode_name,
    ...
    def _can_track(self, inputs: FlightModeInput, vision_fresh: bool, gimbal_fresh: bool) -> bool:
    ...
    def _gimbal_rates(self, inputs: FlightModeInput) -> tuple[float, float]:
    ...
    def _body_yaw_rate(self, inputs: FlightModeInput) -> float:
    ...
    def _forward_vx(self, inputs: FlightModeInput) -> float:
    ...
    def _update_yaw_alignment(self, inputs: FlightModeInput, enabled: bool) -> bool:
    ...
    def _yaw_quality(self, inputs: FlightModeInput) -> float:
        yaw = abs(float(inputs.gimbal_yaw))
        if not math.isfinite(yaw):
            return 0.0
    ...
    def _image_quality(self, inputs: FlightModeInput) -> float:
    ...
    def _target_size_valid(self, inputs: FlightModeInput) -> bool:
